...
class SACAgent:
    ...
    def __init__(self, environment):
        ...
        self.action_dim = self.environment.action_space[0].n
        ...
        self.target_entropy = 0.98 * -np.log(1 / self.environment.action_space[0].n)
    ...
    def critic_loss(self, states_tensor, actions_tensor, rewards_tensor, next_states_tensor, done_tensor):
        ...
        critic_square_error = torch.nn.MSELoss(reduction="none")(soft_q_values.squeeze(-1), next_q_values)
        critic2_square_error = torch.nn.MSELoss(reduction="none")(soft_q_values2.squeeze(-1), next_q_values)
